...
export default async function createUser(
   ...
   try {
      ...
      const info = await mailTransporter.sendMail({
         from: "<ericogmarshall1@gmail.com>",
         to: "ericogmarshall1@gmail.com",
         subject: "Usuário criado com sucesso!",
         text: `Parabéns,${nickname} seu usuário foi criado com sucesso!`,
         html: `<p>Parabéns,${nickname} seu usuário foi criado com sucesso!</p>`
      })
